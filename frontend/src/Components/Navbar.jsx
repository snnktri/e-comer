    ...
    <nav className='bg-gray-800 border-gray-200 px-4 lg:px-6 py-2.5'>
      <div className='flex flex-wrap justify-between items-center mx-auto max-w-screen-xl'>
        ...
        <div className='flex items-center'>
          <Link to="/" alt="Logo">
          <img className="mr-3 h-16" src={Logo} alt="Logo" />
          </Link>
        ...
        !user && !admin ? (
          ...
          <div className="text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">
          ...
          <Link to="/cart" className="relative">
            <div className="relative flex items-center justify-center p-2 shadow-md hover:shadow-xl rounded-full transition-all">
                <GrCart className="h-6 w-6 text-gray-100 hover:text-gray-300 transition-all" />
        ...
        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                 ...
                 to="/"
                 className={({ isActive }) =>
                  `block py-2 pr-4 pl-3 duration-200 border-b ${isActive ? "text-orange-700" : "text-white"} border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 hover:text-orange-700 lg:p-0`
                }
                      >
                       Home
                    </NavLink>
